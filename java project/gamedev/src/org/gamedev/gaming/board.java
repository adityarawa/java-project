...
import org.gamedev.gaming.sprites.Enemy;
import org.gamedev.gaming.sprites.Player;
...
public class board extends JPanel {
	...
	private boolean isCollide(Enemy enemy) {
		...
		int maxW=Math.max(player.w, enemy.w);
		 return xDistance<=maxW-160 && yDistance<=maxH-160;
	...
	private void loadBackgroundImage() {
		try {
			backgroundImage=ImageIO.read(board.class.getResource("game.jpg"));
		} catch (IOException e) {
